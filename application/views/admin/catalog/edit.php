				...
				<form id="demo-form2" method="post" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="">
					...
					<div class="form-group">
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<input type="text" name="name" value="<?php echo $catalog->name ?>" required="required" class="form-control col-md-7 col-xs-12">
						</div>
					</div>
					<div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select class="form-control" name="parent_id">
                            <option <?php  echo $catalog->parent_id == 0 ? 'selected' : '' ?> value="0">Là danh mục cha</option>
                            <?php foreach ($catalog_0 as $value): ?>
                            	<option <?php echo $catalog->parent_id == $value->id ? 'selected' : '' ?> value="<?php echo $value->id ?>"><?php echo $value->name ?></option>
                            <?php endforeach ?>
                          </select>
                        </div>
                     </div>
					...
					<div class="form-group">
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<input id="middle-name" value="<?php echo $catalog->sort_order ?>" class="form-control col-md-7 col-xs-12" type="number" name="sort_order">
						</div>
					</div>
