				...
				<form id="demo-form2" method="post" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<div class="col-md-9 col-sm-9 col-xs-12">
							<input type="text" name="name" value="<?php echo $product->name ?>" id="first-name" required="required" class="form-control col-md-7 col-xs-12">
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-md-3 col-sm-3 col-xs-12">
							<select class="select2_group form-control" name="producer_id">
								<?php foreach ($producers as $producer): ?>
									<option <?php echo $product->producer_id == $producer->id ? 'selected' : '' ?> value="<?php echo $producer->id ?>"><?php echo $producer->name ?></option>
								<?php endforeach ?>
							</select>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-md-3 col-sm-3 col-xs-12">
							<input type="number" name="price" value="<?php echo $product->price ?>" id="first-name" required="required" class="form-control col-md-7 col-xs-12">
						</div>
						<label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Giảm giá  <span class="required">%</span>
						</label>
						<div class="col-md-3 col-sm-3 col-xs-12">
							<input type="number" name="discount" value="<?php echo $product->discount ?>" id="first-name" required="required" class="form-control col-md-7 col-xs-12">
						</div>
					</div>
					<div class="form-group">
